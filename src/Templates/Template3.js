...
const Template3 = (props) => {
  ...
  return (
    <Paper
      ...
      />
      <Container>
        <TemplateHeadingDetails color={"#18aebd"} title={"Professional Experience"} />
        ...
        <TemplateHeadingDetails color={"#18aebd"} title={"Education"} />
        <TemplateEducationDetails education={educationinfo} />
        <TemplateHeadingDetails color={"#18aebd"} title={"Key Skills"} />
